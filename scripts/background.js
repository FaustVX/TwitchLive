...
(function () {
    ...
    let DATA_URL = "https://api.twitch.tv/kraken/users/{0}/follows/channels?limit=" + LIMIT_AMOUNT + "&offset={1}&sortby=last_broadcast";
    ...
    let init = function () {
        ...
        chrome.contextMenus.create({
            "title": "About Twitch Live", "contexts": ["browser_action"],
            "onclick": function () {
